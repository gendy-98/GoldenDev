...
static const char *TAG = "enc28j60 mac";
...
static esp_err_t enc28j60_setup_default(emac_enc28j60_t *emac)
{
    ...
    MAC_CHECK(enc28j60_register_write(emac, ENC28J60_MACON3, MACON3_PADCFG0 | MACON3_TXCRCEN | MACON3_FRMLNEN | MACON3_FULDPX) == ESP_OK, "write MACON3 failed", out, ESP_FAIL);
...
static esp_err_t emac_enc28j60_set_duplex(esp_eth_mac_t *mac, eth_duplex_t duplex)
{
    ...
    //uncomment to force full duplex as well as line 131 in enc_init.c 
