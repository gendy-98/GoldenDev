...
void spp_task_task_start_up(void)
{
    ...
    xTaskCreatePinnedToCore(spp_task_task_handler, "SPPAppT", 2048,  NULL,   3,  &spp_task_task_handle,   0);
    return;
}
...
{
    xTaskCreatePinnedToCore(p_cback, "write_read", 2048, (void *)fd, 5, NULL, 0);
}
